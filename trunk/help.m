...
s = [s, 'remove_by_plane_fitting    - Fit plane to the points and remove points which are far from the plane\n'];
s = [s, 'remove_by_z                - Remove points by Z coordinates\n'];
s = [s, 'remove_downsampling        - Downsampling the cloud\n'];
